...
$catalogue = new MessageCatalogue('de', array (
  ...
  'AppBundle' => 
  array (
    'note.list.link' => 'zurück zur Notizliste',
    'note.list.headline' => 'Verfügbare Notizen',
    'note.list.empty' => 'Keine Notizen gefunden',
    'note.new.link' => 'Neue Notiz anlegen',
    'note.new.headline' => 'Neue Notiz anlegen',
    'note.new.submit' => 'Notiz hinzufügen',
    'note.edit.link' => 'Notiz bearbeiten',
    'note.edit.headline' => 'Notiz \\#%id% bearbeiten',
    'note.edit.submit' => 'Notiz aktualisieren',
    'note.remove.link' => 'entfernen',
    'note.offset' => 'Offset',
    'note.limit' => 'Limit',
    'api.doc.link' => 'API Dokumentation',
  ),
));
